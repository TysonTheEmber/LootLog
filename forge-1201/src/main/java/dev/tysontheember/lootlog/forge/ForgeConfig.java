...
public class ForgeConfig {
    ...
    // General
    private static final ForgeConfigSpec.LongValue DISPLAY_DURATION_MS;
    private static final ForgeConfigSpec.IntValue MAX_ENTRIES;
    private static final ForgeConfigSpec.EnumValue<CombineMode> COMBINE_MODE;
    private static final ForgeConfigSpec.BooleanValue SHOW_ITEMS;
    private static final ForgeConfigSpec.BooleanValue SHOW_XP;
    // Position
    private static final ForgeConfigSpec.EnumValue<HudAnchor> ANCHOR;
    private static final ForgeConfigSpec.IntValue X_OFFSET;
    private static final ForgeConfigSpec.IntValue Y_OFFSET;
    private static final ForgeConfigSpec.IntValue ENTRY_SPACING;
    private static final ForgeConfigSpec.DoubleValue SCALE;
    private static final ForgeConfigSpec.BooleanValue CLAMP_TO_SCREEN;
    private static final ForgeConfigSpec.ConfigValue<String> GROWTH_DIRECTION;

    // Animation
    private static final ForgeConfigSpec.LongValue FADE_IN_MS;
    private static final ForgeConfigSpec.LongValue FADE_OUT_MS;
    private static final ForgeConfigSpec.DoubleValue SLIDE_DISTANCE;
    private static final ForgeConfigSpec.BooleanValue FADE_OUT_SLIDE;
    private static final ForgeConfigSpec.DoubleValue VERTICAL_ANIM_SPEED;
    private static final ForgeConfigSpec.EnumValue<Easing> SLIDE_EASING;
    private static final ForgeConfigSpec.BooleanValue SCALE_ENTRANCE;
    private static final ForgeConfigSpec.DoubleValue ENTRANCE_SCALE_START;
    private static final ForgeConfigSpec.IntValue STAGGER_DELAY_MS;

    // Layout
    private static final ForgeConfigSpec.ConfigValue<String> LAYOUT_PRESET;

    // Appearance
    private static final ForgeConfigSpec.ConfigValue<String> DECORATION;
    private static final ForgeConfigSpec.ConfigValue<String> BACKGROUND_STYLE;
    private static final ForgeConfigSpec.LongValue BACKGROUND_COLOR;
    private static final ForgeConfigSpec.IntValue BACKGROUND_H_PADDING;
    private static final ForgeConfigSpec.IntValue BACKGROUND_V_PADDING;
    private static final ForgeConfigSpec.IntValue MAX_NAME_WIDTH;
    private static final ForgeConfigSpec.LongValue COUNT_COLOR;
    private static final ForgeConfigSpec.LongValue NAME_COLOR_OVERRIDE;
    private static final ForgeConfigSpec.BooleanValue SHOW_COUNT;
    private static final ForgeConfigSpec.BooleanValue USE_RARITY_COLORS;
    private static final ForgeConfigSpec.BooleanValue ICON_ON_RIGHT;
    private static final ForgeConfigSpec.BooleanValue TEXT_SHADOW;
    private static final ForgeConfigSpec.BooleanValue SHOW_COUNT_RIGHT;
    private static final ForgeConfigSpec.BooleanValue ANIMATE_XP_COLOR;
    private static final ForgeConfigSpec.BooleanValue ABBREVIATE_COUNTS;

    // Banner / FLAT layout
    private static final ForgeConfigSpec.ConfigValue<String> BANNER_ELEMENT_ORDER;
    private static final ForgeConfigSpec.IntValue DECORATIVE_EDGE_INSET;
    private static final ForgeConfigSpec.IntValue ICON_TO_NAME_GAP;
    private static final ForgeConfigSpec.IntValue NAME_TO_COUNT_GAP;

    // Banner layer 0 (body)
    private static final ForgeConfigSpec.DoubleValue BODY_ALPHA;
    private static final ForgeConfigSpec.LongValue BODY_TINT;
    private static final ForgeConfigSpec.IntValue BODY_ANIM_SPEED;

    // Banner layer 1 (accent)
    private static final ForgeConfigSpec.BooleanValue SHOW_ACCENT;
    private static final ForgeConfigSpec.DoubleValue ACCENT_ALPHA;
    private static final ForgeConfigSpec.LongValue ACCENT_TINT;
    private static final ForgeConfigSpec.IntValue ACCENT_ANIM_SPEED;
    private static final ForgeConfigSpec.IntValue ACCENT_X_OFFSET;
    private static final ForgeConfigSpec.IntValue ACCENT_Y_OFFSET;
    private static final ForgeConfigSpec.ConfigValue<String> ACCENT_ANCHOR;

    // Effect targeting
    private static final ForgeConfigSpec.ConfigValue<String> EFFECT_TARGET;

    // Pickup Pulse
    private static final ForgeConfigSpec.BooleanValue PICKUP_PULSE_ENABLED;
    private static final ForgeConfigSpec.IntValue PICKUP_PULSE_DURATION_MS;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_ICON_SCALE_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_ICON_ALPHA_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_NAME_SCALE_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_NAME_ALPHA_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_TOTAL_COUNT_SCALE_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_TOTAL_COUNT_ALPHA_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_BODY_SCALE_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_BODY_ALPHA_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_ACCENT_SCALE_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_ACCENT_ALPHA_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_OVERALL_SCALE_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue PICKUP_PULSE_OVERALL_ALPHA_STRENGTH;

    // Progress Bar
    private static final ForgeConfigSpec.BooleanValue SHOW_PROGRESS_BAR;
    private static final ForgeConfigSpec.LongValue PROGRESS_BAR_COLOR;
    private static final ForgeConfigSpec.IntValue PROGRESS_BAR_HEIGHT;

    // Icon Glow
    private static final ForgeConfigSpec.BooleanValue ICON_GLOW_ENABLED;
    private static final ForgeConfigSpec.LongValue ICON_GLOW_COLOR;
    private static final ForgeConfigSpec.IntValue ICON_GLOW_RADIUS;
    private static final ForgeConfigSpec.ConfigValue<String> ICON_GLOW_SHAPE;
    private static final ForgeConfigSpec.DoubleValue ICON_GLOW_SOFTNESS;
    private static final ForgeConfigSpec.DoubleValue ICON_GLOW_PULSE_SPEED;
    private static final ForgeConfigSpec.DoubleValue ICON_GLOW_PULSE_MIN;
    private static final ForgeConfigSpec.DoubleValue ICON_GLOW_PULSE_MAX;

    // Icon Shadow
    private static final ForgeConfigSpec.BooleanValue ICON_SHADOW_ENABLED;
    private static final ForgeConfigSpec.LongValue ICON_SHADOW_COLOR;
    private static final ForgeConfigSpec.IntValue ICON_SHADOW_OFFSET_X;
    private static final ForgeConfigSpec.IntValue ICON_SHADOW_OFFSET_Y;
    private static final ForgeConfigSpec.IntValue ICON_SHADOW_RADIUS;
    private static final ForgeConfigSpec.ConfigValue<String> ICON_SHADOW_SHAPE;
    private static final ForgeConfigSpec.DoubleValue ICON_SHADOW_SOFTNESS;

    // Filtering
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> ITEM_BLACKLIST;
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> ITEM_WHITELIST;
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> MOD_BLACKLIST;
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> MOD_WHITELIST;

    // Sound
    private static final ForgeConfigSpec.BooleanValue SOUND_ENABLED;
    private static final ForgeConfigSpec.ConfigValue<String> SOUND_ID;
    private static final ForgeConfigSpec.DoubleValue SOUND_VOLUME;
    private static final ForgeConfigSpec.DoubleValue SOUND_PITCH;
