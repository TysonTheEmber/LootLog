...
public class NeoForgeHudRenderer implements RenderBridge {
    ...
    public static void registerLayer(RegisterGuiLayersEvent event) {
        event.registerAboveAll(
            ResourceLocation.fromNamespaceAndPath(LootLog.MOD_ID, "pickup_hud"),
            NeoForgeHudRenderer::renderLayer
        );
    }

    private static void renderLayer(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
        NeoForgeHudRenderer renderer = (NeoForgeHudRenderer) LootLog.getRenderBridge();
